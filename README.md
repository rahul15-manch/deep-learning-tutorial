...
└── WEEK-2/
    ...
    └── stochastic vs batch gradient_descent.ipynb
```
...
- insurance_data.csv — used for demonstrating loss and gradient descent calculations.

## 📘 Week 2: Advanced Optimization
### 🔹 1. Stochastic vs Batch Gradient Descent
...
- Explains the speed–accuracy trade-off and when to use each.

### 🔹 Dataset:

- homeprices_banglore.csv — used to apply gradient descent on real-world housing price prediction.
...
- ✅ Understand how neural networks learn using gradient descent.
- ✅ Know the role and effect of different activation and loss functions.
- ✅ Be able to implement and visualize optimization algorithms from scratch.
- ✅ Get hands-on experience with real datasets.
